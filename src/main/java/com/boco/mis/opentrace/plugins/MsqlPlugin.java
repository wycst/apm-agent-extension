...
import com.boco.mis.opentrace.interceptors.InterceptorHelper;
import com.boco.mis.opentrace.reflect.AsmInvoke;

public class MsqlPlugin implements ApmPlugin {
	...
	public void doTrace(Method method, Callable<?> callable,
				...
				if (statementImpl != null) {
					...
					try {
						...
						if (statementImpl != null) {
							...
							Field passwordField = target.getClass()
									.getSuperclass()
